    ...
    <section class="flex min-h-screen justify-center bg-gray-50 dark:bg-gray-800 pb-20">
        <div class="container flex flex-col items-center px-5">
            ...
            <div
                ...
                <div class="flex justify-start flex-wrap flex-col gap-12 items-center sm:items-start sm:flex-nowrap sm:flex-row">
                        ...
                        <div class="wrapper">
                            ...
                            <form class="max-w-sm" action="{{route('market.store')}}" method="POST">
                                ...
                                <div class="mt-4">
                                    ...
                                    <input type="text" name="nickname" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Никнейм" required />
                                </div>
                                <div class="mt-4 flex flex-col">
                                    <label for="text" class="font-bold text-gray-600 sm:text-xl dark:text-gray-100">SteamID</label>
                                    <a href="https://steamid.io/" class="font-thin text-red-500 dark:text-red-300 text-[0.7rem] dark:text-gray-100">*Как узнать SteamID?*</a>
                                    <input type="text" name="steamid" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="SteamID" required />
                                </div>
                                <div class="mt-4">
                                ...
                                <select name="privilegy_link" id="underline_select"
                                    ...
                                    <option value="link_steamid" class="bg-gray-200 dark:bg-gray-200 dark:text-gray-900">SteamID
                                    </option>
                                </select>
                                </div>
                                <button type="submit" class="text-white bg-gray-600 dark:bg-gray-400 hover:bg-pink-500 transition-all hover:dark:bg-pink-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2">
                    ...
                    <div class="right flex flex-col items-center sm:items-end w-full sm:w-1/2 h-full">
                        ...
                        <img src="{{asset('assets/market/hookmenu.png')}}" alt="" class="w-96 rounded border-[1px] border-gray-500">
                    </div>
                </div>
            </div>
        </div>
